    ...
    data() {
        return {
            ...
            questions: [
                ...
                { id: 'q24', text: 'I find the visualization <strong>overloaded</strong>.' },
                { id: 'q25', text: 'I find the <strong>data size</strong> makes the visualization complex.' },
                { id: 'q26', text: 'I find the visualization <strong>dense</strong>.' },
                { id: 'q27', text: 'I feel <strong>informed</strong> by the visualization.' },
                { id: 'q28', text: 'I find the visualization has <strong>overlapping information</strong>.' },
                { id: 'q29', text: 'I feel <strong>overwhelmed</strong> by the visualization.' },
                { id: 'q30', text: 'I feel <strong>stressed</strong> by the visualization.' },
                { id: 'q31', text: 'I find the <strong>visualization type</strong> requires higher cognitive effort.' },
                { id: 'q32', text: 'I feel <strong>engaged</strong> with the visualization.' },
                { id: 'q33', text: 'I find the visualization uses <strong>too many colors</strong>.' },
                { id: 'q34', text: 'I find the visualization provides <strong>not enough context</strong>.' },
                { id: 'q35', text: 'I find the visualization <strong>well organized</strong>.' },
                { id: 'q36', text: 'I find the points in the visualization <strong>easy to distinguish</strong>.' },
                { id: 'q37', text: 'I cannot <strong>distinguish between colors</strong>.' },
                { id: 'q38', text: 'I find the visualization displays <strong>several dimensions at once</strong>.' },
                { id: 'q39', text: 'I find the visualization has a <strong>large number of dimensions with multiple variables</strong>.' },
                ...
                { id: 'q45', text: 'I find the <strong>variables</strong> in the visualization <strong>visible</strong>.' },
                { id: 'q46', text: 'I find the visualization is <strong>poorly designed</strong>.' },
                { id: 'q47', text: 'I find the visualization has a <strong>complex visual appearance</strong>.' },
                { id: 'q48', text: 'I find the additional graphics help <strong>communication</strong>.' }
            ],
        };
    },
    computed: {
