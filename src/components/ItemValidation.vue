    ...
    data() {
        return {
            ...
            questions: [
                ...
                { id: 'q14', text: 'I feel <strong>confident</strong> about this visualization.' },
                { id: 'q15', text: 'I feel <strong>irritated</strong> by this visualization.' },
                { id: 'q16', text: 'I find there is <strong>a lot of information</strong> in this visualization.' },
                { id: 'q17', text: 'I find this visualization <strong>easy to use</strong>.' },
                { id: 'q18', text: 'I find this visualization <strong>intuitive</strong>.' },
                { id: 'q19', text: 'I find this visualization <strong>visually pleasing</strong>.' },
                { id: 'q20', text: 'I feel that this visualization causes <strong>cognitive overload</strong>.' },
                { id: 'q21', text: 'I feel the <strong>mental demand</strong> of this visualization is high/low.' },
                { id: 'q22', text: 'I find the <strong>color coding</strong> overly complex.' },
                { id: 'q23', text: 'I find the <strong>visual encoding</strong> is poor and violates good practice.' },
                { id: 'q24', text: 'I find this visualization <strong>attractive</strong>.' },
                { id: 'q25', text: 'I find the visualization has <strong>unnecessary complexity</strong>.' },
                { id: 'q26', text: 'I find the visualization <strong>easy to comprehend</strong>.' },
                { id: 'q27', text: 'I feel <strong>confused</strong> by the visualization.' },
                { id: 'q28', text: 'I find the visualization <strong>overloaded</strong>.' },
                { id: 'q29', text: 'I find the <strong>large number of data items</strong> makes the visualization too complex.' },
                { id: 'q30', text: 'I find the visualization <strong>dense</strong>.' },
                { id: 'q31', text: 'I feel the visualization is <strong>dense</strong>.' },
                { id: 'q32', text: 'I feel <strong>informed</strong> by the visualization.' },
                { id: 'q33', text: 'I find the visualization has <strong>overlapping information</strong>.' },
                { id: 'q34', text: 'I feel <strong>overwhelmed</strong> by the visualization.' },
                { id: 'q35', text: 'I feel <strong>stressed</strong> by the visualization.' },
                { id: 'q36', text: 'I find the <strong>visualization type</strong> requires higher cognitive effort.' },
                { id: 'q37', text: 'I feel <strong>engaged</strong> with the visualization.' },
                { id: 'q38', text: 'I find the visualization uses <strong>too many colors</strong>.' },
                { id: 'q39', text: 'I find the visualization provides <strong>not enough context</strong>.' },
                { id: 'q40', text: 'I find the visualization <strong>well organized</strong>.' },
                { id: 'q41', text: 'I find this visualization <strong>takes time to understand</strong>.' },
                { id: 'q42', text: 'I find the points in the visualization <strong>easy to distinguish</strong>.' },
                { id: 'q43', text: 'I cannot <strong>distinguish between colors</strong>.' },
                { id: 'q44', text: 'I find the visualization displays <strong>several dimensions at once</strong>.' },
                { id: 'q45', text: 'I can <strong>detect patterns</strong> in the visualization.' },
                { id: 'q46', text: 'I find the visualization is <strong>missing important details</strong>.' },
                { id: 'q47', text: 'I find the visualization requires <strong>effort</strong> to understand.' },
                { id: 'q48', text: 'I find the visualization has <strong>poor pattern visibility</strong>.' },
                { id: 'q49', text: 'I find <strong>all data points are visible</strong> in the visualization.' },
                { id: 'q50', text: 'I find the variables in the visualization <strong>visible</strong>.' },
                { id: 'q51', text: 'I find the visualization is <strong>poorly designed</strong>.' },
                { id: 'q52', text: 'I find the visualization has a <strong>complex visual appearance</strong>.' },
                { id: 'q53', text: 'I find additional graphics would help in <strong>communication</strong>.' }
            ],
        };
    },
    computed: {
