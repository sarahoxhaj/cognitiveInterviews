<template>
    ...
    <div class="bg-gray-50 dark:bg-slate-600 flex flex-col items-center justify-start min-h-screen">
        ...
        <p class="mt-5 max-w-5xl text-center dark:text-white">
            ...
            feel that way. Our goal is to develop a scale that can be used to evaluate the visual complexity of a data
            visualization.</p>
        <p class="mt-5 max-w-5xl text-center dark:text-white
            ">
            This conversation will last around 30 minutes and includes a think-aloud process where you express your
            thought while answering the questions.<br> The audio and the screen will be recorded only for data
        ...
        <p class="mt-4 dark:text-white">Please click <button @click.prevent="goToConsentForm" type="submit"
