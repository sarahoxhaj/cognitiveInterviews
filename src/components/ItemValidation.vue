    ...
    data() {
        return {
            ...
            questions: [
                ...
                { id: 'q24', text: 'I find the visualization <strong>easy to comprehend</strong>.' },
                { id: 'q25', text: 'I find the visualization <strong>overloaded</strong>.' },
                { id: 'q26', text: 'I find the <strong>large number of data items</strong> makes the visualization too complex.' },
                ...
                { id: 'q48', text: 'I find additional graphics would help in <strong>communication</strong>.' }
            ],
        };
    },
    computed: {
